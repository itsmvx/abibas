...
import { genresCreateData, genresNameCheck, imagesProcess } from "@/app/admin/genres/create/GenresServerAction";
import GenresImagesPreview from "@/app/admin/genres/create/GenresImagesPreview";
    ...
    useEffect(() => {
        const timeoutId = setTimeout(async () => {
            if (formState.name.value.length > 0) {
                ...
                const checkResult: boolean | null = await genresNameCheck(formState.name.value);
                if (checkResult === null) {
        ...
        <>
            <div className="w-full min-h-96 mx-auto flex flex-col md:flex-row px-7 gap-y-5 pb-6">
                        ...
                        }>
                            {
                                formState.name.isFilled === false
                                    ...
                                    : formState.name.isValid === false
                                        ? `Genre name can't be filled with unique symbol`
                                        : formState.name.isVerified
                                            ? 'Genre name can be used'
                                            : 'Genre Already exist'
                            }
                        </p>
                        ...
                        <p className={
                        ...
                        }>
                            {
                                formState.slug.isFilled === false
                                    ? 'Genre slug is required! Unique symbol is allowed'
                                    : ''
                            }
                        </p>
                    </div>
                        ...
                        <p className={
                        ...
                        }>
                            {
                                formState.description.isFilled === false
                                    ? 'Genre description is required! Unique symbol is allowed'
                                    : ''
                            }
                        </p>
                    </div>
                ...
                <section
                    ...
                    <GenresImagesPreview imagesPreview={imagesCompressed}/>
                </section>
            </div>
        </>
    );
