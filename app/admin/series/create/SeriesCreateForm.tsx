...
import { seriesCreateData, seriesNameCheck, imagesProcess } from "@/app/admin/series/create/SeriesServerAction";
import SeriesImagesPreview from "@/app/admin/series/create/SeriesImagesPreview";
    ...
    useEffect(() => {
        const timeoutId = setTimeout(async () => {
            if (formState.name.value.length > 0) {
                ...
                const checkResult: boolean | null = await seriesNameCheck(formState.name.value);
                if (checkResult === null) {
        ...
        <>
            <div className="w-full min-h-96 mx-auto flex flex-col md:flex-row px-7 gap-y-5 pb-6">
                        ...
                        }>
                            {
                                formState.name.isFilled === false
                                    ...
                                    : formState.name.isValid === false
                                        ? `Series name can't be filled with unique symbol`
                                        : formState.name.isVerified
                                            ? 'Series name can be used'
                        ...
                        <p className={
                        ...
                        }>
                            {
                                formState.slug.isFilled === false
                                    ? 'Series slug is required! Unique symbol is allowed'
                                    : ''
                            }
                        </p>
                    </div>
                        ...
                        <p className={
                        ...
                        }>
                            {
                                formState.description.isFilled === false
                                    ? 'Series description is required! Unique symbol is allowed'
                                    : ''
                            }
                        </p>
                    </div>
                ...
                <section
                    ...
                    <SeriesImagesPreview imagesPreview={imagesCompressed}/>
                </section>
            </div>
        </>
    );
